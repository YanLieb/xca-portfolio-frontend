	...
	useEffect(() => {
		const addBorder = () => {
			...
			if (videoElement) {
				...
				if (videoElement.offsetHeight < videoContainer.offsetHeight) {
					console.log('video element smaller than its container')
					videoContainer.style.border = '1px solid black';
				} else {
					console.log('video element full in its container')
